  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-[calc(100vh-4rem)]">
        <div className="flex w-full flex-col items-center justify-center bg-emerald-600 px-8 lg:w-1/2">
          <div className="max-w-md text-white">
            <h1 className="mb-6 text-4xl font-bold">
              From the Hearts of Local Markets
            </h1>
            <p className="mb-4 text-lg">to the Palm of Your Hand</p>
        ...
        <div className="flex w-full items-center justify-center bg-gray-50 px-8 py-12 lg:w-1/2">
